  ...
  return (
    <div className="LandingPage overflow-hidden">
      ...
      <div className="grid-col">
        <div className="flex justify-center">
          <div id="FFTitle" className="absolute z-10">
            <h1 className="righteous text-3xl lg:text-8xl text-white mt-10 mb-10 text-center">
              Welcome to <br></br>Film Friendzy!
            </h1>

            <p className="jose text-2xl lg:text-3xl text-white text-center mb-28">
              Movie nights with friends from anywhere!
            </p>

            <p className="jose text-sm lg:text-2xl text-white mb-1 text-center">
      ...
      <div className="bg-slate-900 border-t-2 border-red-600">
        <div className="text-white text-center text-2xl mt-10 mb-10">
          <h1>
            <b> Available on your favorite devices</b>{" "}
          </h1>
        </div>
        <div className="grid grid-cols-1  bg-slate-900 border-red-600 md:grid-cols-2 lg:grid-cols-4 gap-4 ml-28">
          <div className="bg-slate-900 p-4 shadow-md text-white ">
            {" "}
            <br />
          ...
          <div className="bg-slate-900 text-white p-4 shadow-md mb-10">
            {" "}
            <br />
