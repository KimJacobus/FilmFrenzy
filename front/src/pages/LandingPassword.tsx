    ...
    return (
        ...
        <div className='flex justify-center'>
            ...
            <div id="FFTitle" className='absolute z-10'>
                <h1 className='righteous text-3xl lg:text-8xl text-white mt-10 mb-12 text-center'>Welcome to <br></br>Film Friendzy!</h1>
                
                <p className='jose text-2xl lg:text-3xl text-white text-center mb-6 '>Movie nights with friends from anywhere!</p>

                

                <Password />
                <p className='jose text-sm lg:text-2xl text-white mb-1 text-center mt-7 '>Step 3/4</p>
                

                <p className='jose text-sm lg:text-2xl text-white mb-1 text-center mt-7 '>Sign up now and get a friend to join for free !</p>
        ...
        <div className='bg-gradient-to-b from-indigo-800 ...'>
            <img className='w-screen lg:h-auto h-80 opacity-40 overflow-hidden' src={salle }/>
